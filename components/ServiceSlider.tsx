          ...
          <SwiperSlide key={item.title}>
            <div className="rounded-md cursor-pointer flex flex-col gap-6 mb-10 group relative text-white shadow-lg rounde-xl px-6 py-8 h-[300px] w-[250px] overflow-hidden">
              ...
              <div className="relative flex flex-col gap-3">
                ...
                {/* Modified title styles for visibility */}
                <h1 className="text-xl lg:text-2xl font-semibold bg-black bg-opacity-40 px-2 py-1 rounded">{item.title}</h1>
                {/* Modified content styles for visibility */}
                <p className="lg:text-[18px] font-medium bg-black bg-opacity-40 px-2 py-1 rounded">{item.content}</p>
              </div>
            </div>
          </SwiperSlide>
        ))}
